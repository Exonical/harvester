...
func isDaemenSetClean(appsFactory *ctlapps.Factory, namespace, name string) (string, wait.ConditionFunc) {
...
func isDaemenSetReady(appsFactory *ctlapps.Factory, namespace, name string) (string, wait.ConditionFunc) {
