...
// BuildOwnerReference creates an owner reference to a `VolumeRemoteRestore` CR.
// This ties the composed PVC, ensuring that the PVC are automatically deleted
// when the `VolumeRemoteRestore` is deleted.
