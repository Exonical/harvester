...
// ErrSkip is a sentinel error that indicates the handler should be considered successful.
var ErrSkip = errors.New("skip")

// Cond is a named condition type used to get/set conditions on K8s objects via reflection.
type Cond string
...
// Error wraps an error with a reason for condition error reporting.
